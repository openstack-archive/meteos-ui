...
(function() {
  ...
  angular
    ...
    .factory('horizon.dashboard.machine_learning.models.delete.service', deleteService);
  ...
  /**
   * @ngDoc factory
   * @name horizon.dashboard.machine_learning.models.delete.service
   * @Description
   * Brings up the delete models confirmation modal dialog.
  ...
  function deleteService(
    ...
    var notAllowedMessage = gettext("You are not allowed to delete models: %s");
    ...
    function labelize(count){
      return {
        title: ngettext('Confirm Delete Model',
                        'Confirm Delete Models', count),
        /* eslint-disable max-len */
        message: ngettext('You have selected "%s". Please confirm your selection. Deleted model is not recoverable.',
                          'You have selected "%s". Please confirm your selection. Deleted models are not recoverable.', count),
        /* eslint-enable max-len */
        submit: ngettext('Delete Model',
                         'Delete Models', count),
        success: ngettext('Deleted Model: %s.',
                          'Deleted Models: %s.', count),
        error: ngettext('Unable to delete Model: %s.',
                        'Unable to delete Models: %s.', count)
      };
    }
    ...
    function deleteEntity(id){
      return meteos.deleteModel(id, true);
    }
  }
})();
