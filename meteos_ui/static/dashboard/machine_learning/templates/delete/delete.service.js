...
(function() {
  ...
  angular
    ...
    .factory('horizon.dashboard.machine_learning.templates.delete.service', deleteService);
  ...
  deleteService.$inject = [
    ...
    'horizon.dashboard.machine_learning.templates.events'
  ];

  /**
   * @ngDoc factory
   * @name horizon.dashboard.machine_learning.templates.delete.service
   * @Description
  ...
  function deleteService(
    ...
    var notAllowedMessage = gettext("You are not allowed to delete templates: %s");
    ...
    function labelize(count){
      return {
        title: ngettext('Confirm Delete Template',
                        'Confirm Delete Templates', count),
        /* eslint-disable max-len */
        message: ngettext('You have selected "%s". Please confirm your selection. Deleted template is not recoverable.',
                          'You have selected "%s". Please confirm your selection. Deleted templates are not recoverable.', count),
        /* eslint-enable max-len */
        submit: ngettext('Delete Template',
                         'Delete Templates', count),
        success: ngettext('Deleted Template: %s.',
                          'Deleted Templates: %s.', count),
        error: ngettext('Unable to delete Template: %s.',
    ...
    function createResult(deleteModalResult) {
      ...
      if(result.result.failed.length == 0 && result.result.deleted.length > 0){
        $location.path('/project/machine_learning/templates');
      }else{
    ...
    function deleteEntity(id){
      return meteos.deleteTemplate(id, true);
    }
  }
})();
